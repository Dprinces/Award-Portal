...
const ForgotPassword = () => {
  ...
  const handleResend = async () => {
    ...
    try {
      const response = await api.post("/auth/forgot-password", { email });
      setMessage(response.data.message || "Password reset email sent again!");
    } catch (err) {
      setError(
        err.response?.data?.message ||
            ...
            >
              ...
              <div className="space-y-3">
                ...
                >
                  <RouterLink
                    to="/login"
                    className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200"
                  >
